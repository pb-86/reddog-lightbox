...
function rddglb_add_scripts() {
	wp_register_script( 'rddglb-master', PLUGIN_PATH . 'assets/scripts/master.js', array(), PLUGIN_VERSION, true );
...
function rddglb_add_styles() {
	wp_register_style( 'rddglb-master', PLUGIN_PATH . 'assets/styles/css/master.css', array(), PLUGIN_VERSION, 'all' );
